...
//       const amount = getBasketTotal(basket) * 100; // Convert to paise
//       const { data } = await axios.post("/create-order", {
//         amount: amount,
//         currency: "INR",
//       });

//       setOrderId(data.id); // Store the order ID
...
//       amount: getBasketTotal(basket) * 100, // Convert amount to paise
//       currency: "INR",
//       name: "Your Company Name",
//       description: "Test Transaction",
//       order_id: orderId, // Pass the order ID created on the server
